...
export default function HeroSection() {
  // NOTE: Replace this placeholder URL with your actual high-resolution background image.
  ...
  return (
    <section className="relative h-[65vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 text-center z-10 text-cyan-50"> {/* Base Text Color Changed */}
        
        {/* Main Heading (Highlighted) */}
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-6 leading-tight drop-shadow-lg text-white"> {/* Heading Color Changed */}
          Connect, Explore, <br className="hidden sm:inline" />
          And Share Adventures
        </h1>
        
        {/* Subtitle (Soft contrast) */}
